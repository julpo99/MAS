...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[circle,draw, label={[red]left:0, 1}] {B}
                    child{
                        node[draw, black] {0, 1}
                        edge from parent [left, red] node {I}
                    }
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[circle, black,draw, label={[red]left:-1, -1}] {B}
                    child{
                        node[draw, black] {-1, -1}
                        edge from parent [left, red] node {Ft}
                    }
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[circle, draw, label={[red]right: 0, 1}] {E}
                child{
                        node[draw] {1, 0} 
                        edge from parent [left, black] node {H}
                    }
                child {
                    node[circle, draw, label={[red]left: 0, 1}] {B}
                    child{
                        node[draw, black] {0, 1}
                        edge from parent [left, red] node {I}
                    }
    ...
    \end{tikzpicture}
    \caption{Subgame 3 with NE (IS, FiH).}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[circle, black, draw, label={[red]right: 1, 0}] {E}
                child {
                    node[circle, black, draw, label={[red]left: -1, -1}] {B}
                    child {
                        node [draw] {-1, -1}
                        edge from parent [left, red] node {Ft}
                    }
    ...
    \end{tikzpicture}
    \caption{Subgame 4 with NEs (FtQ).}
\end{figure}

Figures 2-5 show the subgames and mention their NEs. The only subgame-perfect equilibrium is (WIFtSQ), as it is the
