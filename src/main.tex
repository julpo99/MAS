...
% Document
\begin{document}
    \author{Julian Ramondo - 2785746 \and Lukas Xxxx - 0000000 \and Mika Rosin - 0000000}
    \maketitle
    ...
    \subsubsection{Same question as above, but now assume that all we know is that a = 0.1 and a<b\leq1.}
